      ...
      <div style={{ display:'flex', gap:12, paddingBottom:16 }}>
        {isHost ? (
          ...
          <div style={{ display:'flex', gap:10 }}>
            <button onClick={() => respondToWordChainInvite(roomId,currentUser.uid,'declined')} style={{ padding:'11px 20px', borderRadius:10, background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', color:'rgba(255,255,255,0.4)', fontFamily:'Oswald', fontSize:'0.82rem', cursor:'pointer' }}>Decline</button>
            <button onClick={() => respondToWordChainInvite(roomId,currentUser.uid,'accepted')} style={{ padding:'11px 28px', borderRadius:10, border:'none', background:'linear-gradient(135deg,#10b981,#3b82f6)', color:'#fff', fontFamily:'Oswald', fontSize:'0.88rem', fontWeight:700, letterSpacing:'0.12em', cursor:'pointer' }}>✅ Accept</button>
          </div>
        )}
      </div>
    </div>
